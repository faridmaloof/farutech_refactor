...
Route::prefix('locations')->group(function () {
    Route::get('search', 'App\Http\Controllers\Api\V1\LocationController@search');
    Route::get('{id}', 'App\Http\Controllers\Api\V1\LocationController@show')->whereNumber('id');
    Route::get('{id}/hierarchy', 'App\Http\Controllers\Api\V1\LocationController@hierarchy')->whereNumber('id');
});
...
Route::prefix('admin')->middleware('auth:sanctum')->group(function () {
    ...
    Route::prefix('leads')->group(function () {
        ...
        Route::post('/', 'App\Http\Controllers\LeadController@store');
        Route::get('{lead}', 'App\Http\Controllers\LeadController@show');
        Route::put('{lead}', 'App\Http\Controllers\LeadController@update');
        Route::delete('{lead}', 'App\Http\Controllers\LeadController@destroy');
    });
