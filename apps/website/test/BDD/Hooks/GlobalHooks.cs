...
/// <summary>
/// Hooks globales del ciclo de vida de los tests de Farutech Website.
/// Configura el browser (Playwright) y el actor con BrowseTheWeb para escenarios @web.
/// Configura el actor con CallAnApi para escenarios @api.
/// </summary>
/// <remarks>
...
public class GlobalHooks(ScenarioContext scenarioContext)
{
    ...
    {
        Console.WriteLine("=== Farutech Website Tests — Run Started ===");
    }
    ...
    {
        Console.WriteLine("=== Farutech Website Tests — Run Finished ===");
    }
