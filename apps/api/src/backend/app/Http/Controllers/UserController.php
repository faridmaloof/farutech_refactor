...
class UserController extends Controller
{
    ...
    /**
     * Devuelve un usuario individual.
     *
     * @OA\Get(
     *     path="/admin/users/{id}",
    ...
    /**
     * Actualiza un usuario. El role solo es modificable cuando la
     * creación de usuarios está habilitada (registration_enabled).
     *
     * @OA\Put(
     *     path="/admin/users/{id}",
    ...
    public function update(Request $request, User $user)
    {
        ...
        if (isset($data['role']) && ! $settings->registration_enabled) {
            return response()->json([
                'message' => 'La modificación de roles está deshabilitada en Configuración.',
            ], 403);
        }
    ...
    /**
     * Elimina un usuario (impide auto-eliminación).
     *
     * @OA\Delete(
     *     path="/admin/users/{id}",
